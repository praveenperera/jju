...
use super::super::helpers::{
    bookmark_is_on_rev, is_bookmark_move_backwards, previous_char_boundary,
};
...
pub(super) fn confirm_bookmark_picker(ctx: &mut ReduceCtx<'_>) {
    ...
    match action {
        BookmarkSelectAction::Move => confirm_move_bookmark_picker(ctx, bookmark_name, target_rev),
